...
•DONE• mp7 transactions CRUD api/components. only administrators can update the transaction. export PDF when the transaction is completed. React-pdf library

quiz 1 15pts
Simple validation/error messages Toast Alert and similar notifications libraries 10pts
•DONE•React validation for CRUD form components. you can use React-hook-form 15pts 
(user/updatePassword, admin/newProduct, user/Login, user/register)

quiz 2 15pts
search component/api on homepage  10ptss
•DONE• search component/api with autocomplete on homepage  you can use react-autocomplete react-search-autocomplete or equivalent libraries 15pts 

quiz 3 15pts
•DONE•pagination on homepage (datatable pagination is not applicable) 10pts
infinite scroll on homepage react-infinite-scroll-component 15pts

quiz 4 15pts
•DONE•three(3) js charts  (bar, pie and line). simple count/average/percentages REchart or chart-js 10pts
three(3) js charts (bar, pie and line). chart will change based on input such as dates or keywords REcharts or chart-js  15pts

unit test 2 20pts
•DONE•Login/Logout Authentication with token generation  15pts
...
Last modified: Tuesday, 11 April 2023, 10:27 AM
